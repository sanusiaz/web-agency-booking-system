...
<head>
    ...
    <meta name="description" content="Book a session with our Agency. We create professional websites.">
...
<body class="bg-gray-950 text-white min-h-screen flex flex-col antialiased selection:bg-blue-500 selection:text-white">
    ...
    <div class="fixed bottom-6 right-6 flex flex-col space-y-4 z-50">
        ...
        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" version="1.1">
...
<script xmlns=""/></svg>
    ...
    <!-- Cookie Consent -->
    <div id="cookie-banner" class="fixed bottom-2 border rounded-md left-2 w-full bg-gray-900 border-t z-50 lg:max-w-[400px] border-gray-800 p-4 hidden">
